      ...
      <div class="border rounded-lg divide-y divide-gray-200 dark:border-gray-700 dark:divide-gray-700">
        ...
        <div class="py-3 px-4 flex items-center justify-between">
          ...
          <div>
            ...
            <a href="index.php?act=categories-add" class="inline-block rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Nhập thêm</a>
          </div>
        </div>
            ...
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
              <?php
                foreach($categories as $category):
                  extract($category);
                  $update = "index.php?act=categories-update&id=".$categoryID;
                  $delete = "index.php?act=categories-delete&id=".$categoryID;
              ?>
                <tr>
                  <!-- checkbox -->
                  ...
                  <!-- id -->
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm text-left text-gray-900"><?= $categoryID ?></div>
                  </td>
                  <!-- Role -->
