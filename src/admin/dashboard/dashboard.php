<div class="p-6">
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
    <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
      <div class="flex justify-between mb-6">
        <div>
          <div class="flex items-center mb-1">
            <div class="text-2xl font-semibold"><?= $totalUsers["countUser"] ?></div>
          </div>
      ...
      <a href="index.php?act=users-list" class="text-[#f84525] font-medium text-sm hover:text-red-800">Xem</a>
    </div>
    ...
    <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
      <div class="flex justify-between mb-4">
        <div>
          <div class="flex items-center mb-1">
            <div class="text-2xl font-semibold"><?= $totalProducts['countProducts'] ?></div>
      ...
      <a href="index.php?act=products-list" class="text-[#f84525] font-medium text-sm hover:text-red-800">Xem</a>
    </div>

    <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
      <div class="flex justify-between mb-6">
        <div>
          <div class="text-2xl font-semibold mb-1"><?= $totalCategories['countCategories'] ?></div>
          <div class="text-sm font-medium text-gray-400">Thể loại</div>
        </div>
        <div class="dropdown">
          <button type="button" class="dropdown-toggle text-gray-400 hover:text-gray-600"><i class="ri-more-fill"></i></button>
          <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
      ...
      <a href="index.php?act=categories-list" class="text-[#f84525] font-medium text-sm hover:text-red-800">Xem</a>
    </div>
  </div>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-white border border-gray-100 shadow-md shadow-black/5 p-6 rounded-md">
      <div class="flex justify-between mb-4 items-start">
        <div class="font-medium">Chart</div>
        <div class="dropdown">
          <button type="button" class="dropdown-toggle text-gray-400 hover:text-gray-600"><i class="ri-more-fill"></i></button>
          <ul class="dropdown-menu shadow-md shadow-black/5 z-30 hidden py-1.5 rounded-md bg-white border border-gray-100 w-full max-w-[140px]">
            <li>
...
<script>
  ...
  const data = google.visualization.arrayToDataTable([
    ...
    <?php foreach($loadChart as $dataChart): ?>
    ['<?= $dataChart['name'] ?>', <?= $dataChart['productCount'] ?>],
    <?php endforeach ?>
