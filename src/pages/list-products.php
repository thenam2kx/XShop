    ...
    <section class="relative overflow-hidden">
      <div class="grid grid-cols-6 transition-transform duration-500 ease-in-out">
        ...
        <div class="p-1 w-full">
          <a href="" class="flex flex-col border rounded-lg border-[#ebebf0]">
            <!-- {/* ===== Image product ===== */} -->
            <div class="">
              <img class="w-full h-fit object-cover" src="https://salt.tikicdn.com/cache/280x280/ts/product/27/76/d9/574e043fa75e5d40be24d8007d03df67.jpg.webp" alt="" />
            </div>
            <!-- {/* ===== infor product ===== */} -->
            <div class="flex flex-col gap-1 p-2">
              ...
              <div class="flex flex-col gap-1">
                <p class="text-xs">Quánh Inox PoongNyun WTPIH-16B - Size 16cm</p>
                ...
                <span class="text-base font-semibold text-[#ff424e]">800.000<sup>₫</sup></span>
                <div class="flex items-start gap-1">
                  <span class="px-1 text-xs rounded-lg bg-[#f5f5fa]">-50%</span>
