...
<div class="max-w-7xl">
  <section class="grid grid-cols-1 lg:grid-cols-2 mx-auto py-5 px-4 sm:px-6 lg:px-8 rounded-lg bg-white">
      ...
      <div class="swiper main-slide-carousel swiper-container relative mb-6">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <div class="block">
              <img src="./public/images/products/<?= $thumbnail ?>" alt="Summer Travel Bag image"
    ...
    <div class="flex justify-center items-center">
      <div class="pro-detail w-full max-lg:max-w-[608px] lg:pl-8 xl:pl-16 max-lg:mx-auto max-lg:mt-8">
        <div class="flex items-center justify-between gap-6 mb-6">
          <div class="text">
            <h2 class="font-manrope font-bold text-3xl leading-10 text-gray-900 mb-2"><?= $productItem['name'] ?></h2>
            <p class="font-normal text-base text-gray-500"><?= $special === 0 ? 'Normal' : 'Special' ?></p>
          </div>
          <button class="group transition-all duration-500 p-0.5">
            <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle class="fill-indigo-50 transition-all duration-500 group-hover:fill-indigo-100" cx="30" cy="30"
                r="30" fill="" />
        ...
        <div class="flex flex-col min-[400px]:flex-row min-[400px]:items-center mb-8 gap-y-3">
          <div class="flex items-center">
            <h5 class="font-manrope font-semibold text-2xl leading-9 text-gray-900 "><?= number_format($unitPrice) ?> <sup>đ</sup></h5>
            <span class="ml-3 font-semibold text-lg text-indigo-600"><?= number_format($discount) ?>% off</span>
          </div>
        ...
        <div class="flex items-center flex-col min-[400px]:flex-row gap-3 mb-3 min-[400px]:mb-8">
          ...
          <button
            ...
            <svg class="stroke-indigo-600 transition-all duration-500 group-hover:stroke-indigo-600" width="22"
  ...
  <section class="w-full h-fit rounded-lg mt-4 bg-white">
    <div class="p-4 flex flex-col gap-3">
      ...
      <section class="flex items-center justify-between">
        <h3 class="text-base font-semibold">Sản phẩm cùng loại</h3>
      ...
      <section class="relative overflow-hidden">
        <div class="grid grid-cols-6 transition-transform duration-500 ease-in-out">
          <?php
            foreach ($productsTheSame as $productTheSame):
              extract($productTheSame);
          ?>
